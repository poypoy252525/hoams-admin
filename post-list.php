                            ...
                            <?php
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo '<tr>
                                                <td><p class="post-title">'.$row['post_title'].'</p></td>
                                                <td><p>'.$row['date_created'].'</p></td>
                                                <td><span class="badge badge-success">Published</span></td>
                                                <td>
                                                    <a href="#" class="btn btn-transparent-dark btn-fit">
                                                    ...
                                                    <a href="includes/delete-post.inc.php?postid='.$row['id'].'" class="btn btn-transparent-dark btn-fit">

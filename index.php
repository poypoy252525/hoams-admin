...
<?php $headerIcon = '<svg class="icon icon-dark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M64 64c0-17.7-14.3-32-32-32S0 46.3 0 64V400c0 44.2 35.8 80 80 80H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H80c-8.8 0-16-7.2-16-16V64zm406.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L320 210.7l-57.4-57.4c-12.5-12.5-32.8-12.5-45.3 0l-112 112c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L240 221.3l57.4 57.4c12.5 12.5 32.8 12.5 45.3 0l128-128z"/></svg>' ?>
...
<div class="row">
    <div class="col-xl-3 col-md-6">
        <div class="card shadow card-plan card-plan-primary mb-4">
            <div class="card-content">
                <section>
                    <h3 class="card-title">Users Registered</h3>
                    <p class="card-subtitle mb-1"><?= $usersCount ?> users</p>
                    <a href="#" class="link link-arrow card-link">View</a>
                </section>
                <i class="fa-solid fa-user card-plan-icon"></i>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-md-6">
        <div class="card shadow card-plan card-plan-success mb-4">
            <div class="card-content">
                <section>
                    <h3 class="card-title">Posts</h3>
                    <p class="card-subtitle mb-1"><?= $postsCount ?> Published</p>
                    <a href="#" class="link link-arrow card-link">View</a>
                </section>
                <i class="fa-solid fa-list-check card-plan-icon"></i>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-md-6">
        <div class="card shadow card-plan card-plan-primary mb-4">
            <div class="card-content">
                <section>
                    ...
                    <p class="card-subtitle mb-1">16 Registered</p>
                    <a href="#" class="link link-arrow card-link">View</a>
                </section>
                <i class="fa-solid fa-users card-plan-icon"></i>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-md-6">
        <div class="card shadow card-plan card-plan-danger mb-4">
            <div class="card-content">
                <section>
                    <h3 class="card-title">Pending post</h3>
                    <p class="card-subtitle mb-1">0 Pending</p>
                    <a href="#" class="link link-arrow card-link">View</a>
                </section>
                <i class="fa-regular fa-hourglass-half card-plan-icon"></i>
            </div>
        </div>
    </div>
</div>

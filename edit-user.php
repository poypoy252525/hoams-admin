...
<div class="mb-4"></div>
<form action="includes/edit-user.inc.php?<?= (isset($row) ? 'id='.$row['id'] : 'null') ?>" method="POST" enctype="multipart/form-data">
    <div class="row">
        <div class="col-xl-4">
                ...
                <section class="card-content">
                    <div class="profile-picture-panel">
                        <div class="user-profile center">
                            <img id="profile-picture" src="<?= ( isset($row) ? $row['profile_dir'] : 'images/user.png') ?>" alt="profile" class="image-fluid">
                        </div>
                        ...
                        <input value="" type="file" id="upload-profile" name="file" accept=".jpg, .png" class="input">
                    </div>
                </section>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="input-group">
                                ...
                                <input value="<?= ( isset($row) ? $row['first_name'] : '') ?>" type="text" id="fname" name="fname" class="input input-stretch" placeholder="Enter your first name" required>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="input-group">
                                <label for="lname" class="input-label">Last Name</label>
                                <input value="<?= ( isset($row) ? $row['last_name'] : '') ?>" type="text" id="lname" name="lname" class="input input-stretch" placeholder="Enter your last name" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="input-group">
                                ...
                                <input value="<?= ( isset($row) ? $row['email'] : '') ?>" type="email" id="email" name="email" class="input input-stretch" placeholder="Enter your email address" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="input-group">
                                ...
                                <select name="role" id="role" class="input input-stretch" required>
                                    ...
                                    <option <?= (isset($row) && $row['role'] === "Administrator") ? 'selected' : '' ?>>Administrator</option>
                                    <option <?= (isset($row) && $row['role'] === "Registered") ? 'selected' : '' ?>>Registered</option>
                                    <option <?= (isset($row) && $row['role'] === "Guest") ? 'selected' : '' ?>>Guest</option>
                                </select>
                            </div>
                        </div>
                    </div>
